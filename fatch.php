...
<body>
    ...
    <h4><a href="registration.php" class="btn btn-secondary">Add Data</a><a href="home.php" class="btn btn-success">HOME</a>   <a href="logout.php" class="btn btn-danger">Logout</a></h4>
 
    <nav class="navbar navbar-light bg-light">
  <form class="form-inline" action="fatch.php" method="POST">
...
include('db.php');
$sql="select * from php order by roll_no asc";
