                    ...
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form class="mx-1 mx-md-4" action="#" method="post">
                        ...
                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                          <input type="submit" class="btn btn-primary btn-lg" name="reg" value="sign up">
                        </div>
...
if(isset($_POST['reg']))
{
  ...
  if($result){
    ?>
    <script>
      alert("your id was created");
      window.open("http://localhost/abhishek/project/home.php","_self");
    </script>
